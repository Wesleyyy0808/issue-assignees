    ...
    */
    ...
    const generatorContributors = async (project_name, issue_title) => {
        if (ReposMap[project_name].type === 'isComponent') {
            ...
            var ranlist = '[{\"name\":\"QD\",\"fullName\":\"前端\",\"tasks\":[{\"name\":\"QD\",\"fullName\":\"前端全部项目\",\"contributors\":[\"wesleyyy0808\"]}]},{\"name\":\"HD\",\"fullName\":\"后端\",\"tasks\":[{\"name\":\"HD\",\"fullName\":\"后端全部项目\",\"contributors\":[\"ddos-ling\"]}]},{\"name\":\"issue\",\"fullName\":\"issue\",\"tasks\":[{\"name\":\"issue\",\"fullName\":\"issue\",\"contributors\":[\"wesleyyy0808\",\"ddos-ling\"]}]},{\"name\":\"bug\",\"fullName\":\"bug\",\"tasks\":[{\"name\":\"bug\",\"fullName\":\"bug\",\"contributors\":[\"wesleyyy0808\",\"ddos-ling\"]}]},{\"name\":\"PR\",\"fullName\":\"pr\",\"tasks\":[{\"name\":\"pr\",\"fullName\":\"pr\",\"contributors\":[\"wesleyyy0808\"]}]}{\"name\":\"TDL\",\"fullName\":\"ToDoList\",\"tasks\":[{\"name\":\"TDL\",\"fullName\":\"ToDoList\",\"contributors\":[\"wesleyyy0808\",\"ddos-ling\"]}]},{\"name\":\"QDTDL\",\"fullName\":\"QDToDoList\",\"tasks\":[{\"name\":\"QDTDL\",\"fullName\":\"QDToDoList\",\"contributors\":[\"wesleyyy0808\",\"ddos-ling\"]}]},{\"name\":\"HDTDL\",\"fullName\":\"HDToDoList\",\"tasks\":[{\"name\":\"HDTDL\",\"fullName\":\"HDToDoList\",\"contributors\":[\"wesleyyy0808\",\"ddos-ling\"]}]}]'
            const data = JSON.parse(ranlist)
            //截取issue title中的[]的内容
            let component = issue_title.match(/\[(\w+)\]/i);
            if (!component) {
                component = issue_title.match(/\[([\u4e00-\u9fa5]+)\]/i);
                if (!component) {
            ...
            return ReposMap["wesleyyy0808"].owner;
        }
        return ReposMap["wesleyyy0808"].owner
    }
